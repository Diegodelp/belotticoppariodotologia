...
export interface MarketingInsightsResponse {
  ...
  charts: {
    ...
    appointmentTrend: Array<{ label: string; booked: number; attended: number }>;
    patientTrend: Array<{ label: string; patients: number }>;
  };
  ai: {
    summary: string;
    opportunities: string[];
    risks: string[];
    whatsappCampaigns: Array<{ title: string; script: string; callToAction: string }>;
    instagramCampaigns: Array<{
      title: string;
      concept: string;
      caption: string;
      callToAction: string;

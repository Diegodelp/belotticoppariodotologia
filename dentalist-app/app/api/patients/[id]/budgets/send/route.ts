...
import { getBudgetById, getProfessionalProfile } from '@/lib/db/supabase-repository';
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const [budget, professional] = await Promise.all([
      getBudgetById(ownerProfessionalId, patient.id, budgetId),

...
export default function TreatmentsPage() {
    ...
    return treatments.filter((treatment) => {
      ...
      if (enableClinicFilter) {
        if (clinicFilter === '__none__') {
          if (treatment.patient?.clinicName) {
            return false;
          }
          ...
          if ((treatment.patient?.clinicName ?? '').toLowerCase() !== selectedClinicName) {
            return false;
          }
        }
      }
  ...
  }, [filter, fromDate, toDate, treatments, enableClinicFilter, clinicFilter, clinics]);

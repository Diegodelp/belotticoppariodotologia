  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/70 px-4 py-8">
          <div className="flex min-h-full items-center justify-center">
            <form
              ...
              className="w-full max-w-lg max-h-[calc(100vh-4rem)] overflow-y-auto space-y-4 rounded-2xl border border-white/10 bg-slate-900 p-6 shadow-2xl shadow-cyan-500/10"
            >
      ...
      {clinicModalOpen && selectedClinicCard ? (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/70 px-4 py-8">
          <div className="flex min-h-full items-center justify-center">
            <div className="w-full max-w-4xl max-h-[calc(100vh-4rem)] overflow-y-auto space-y-6 rounded-3xl border border-white/10 bg-slate-900 p-6 shadow-2xl shadow-cyan-500/10">
